...
<template>
  <AuthLayout>
    <h1 class="font-titulares text-2xl text-antracita text-center mb-4">Recuperar contraseña</h1>
    <div class="mb-4 text-sm font-principal text-antracita/70">
    ...
    <form @submit.prevent="handleForgotPassword()">
      ...
      <div class="flex items-center justify-end mt-4">
        <PrimaryButton class="w-full" :class="{ 'opacity-25': processing }" :disabled="processing"
          >Restablecer contraseña</PrimaryButton
        >
      </div>
    </form>
    <RouterLink
